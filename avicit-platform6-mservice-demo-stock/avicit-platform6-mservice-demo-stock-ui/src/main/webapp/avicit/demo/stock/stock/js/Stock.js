 ...
 */
function Stock(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
...
Stock.prototype.init=function(){
	...
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getStocksByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
 ...
 * 添加页面
 */
Stock.prototype.insert=function(){
 ...
 * 编辑页面
 */
Stock.prototype.modify=function(){
 ...
 * 详情页面
 */
Stock.prototype.detail=function(id){
 ...
 * 打开高级查询框
 */
Stock.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
Stock.prototype.formValidate=function(form){
	form.validate({
		rules: {
						  		     			 		  				  				  		     			    				   				   num:{
						number:true
 ...
 * 保存方法
 */
Stock.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
 ...
 * 重载数据
 */
Stock.prototype.reLoad=function(){
 ...
 * 关闭对话框
 */
Stock.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
Stock.prototype.searchData =function(){
 ...
 * 关键字段查询
 */
Stock.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
Stock.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
Stock.prototype.clearData =function(){
