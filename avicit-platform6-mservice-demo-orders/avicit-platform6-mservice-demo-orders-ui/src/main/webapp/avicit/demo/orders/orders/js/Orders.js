 ...
 */
function Orders(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
...
Orders.prototype.init=function(){
	...
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getOrderssByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
 ...
 * 添加页面
 */
Orders.prototype.insert=function(){
 ...
 * 编辑页面
 */
Orders.prototype.modify=function(){
 ...
 * 详情页面
 */
Orders.prototype.detail=function(id){
 ...
 * 打开高级查询框
 */
Orders.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
Orders.prototype.formValidate=function(form){
	form.validate({
		rules: {
						  		     			 		  				  		     			    				   					code:{
						maxlength: 50
 ...
 * 保存方法
 */
Orders.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
 ...
 * 重载数据
 */
Orders.prototype.reLoad=function(){
 ...
 * 关闭对话框
 */
Orders.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
Orders.prototype.searchData =function(){
 ...
 * 关键字段查询
 */
Orders.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
Orders.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
Orders.prototype.clearData =function(){
